...
export default function HeroSection() {
  return (
    <section className="min-h-screen flex items-center justify-center px-4 pt-8 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          <h1
            className="font-unbounded font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl mb-6 animate-fade-up"
            style={{ fontKerning: 'normal', lineHeight: '1.2' }}
          >
            E-SHOP PODLE VAŠICH <span className="text-primary-red">PRAVIDEL</span>
            <br />
            NE PODLE OMEZENÍ <span className="text-primary-red">PLATFORMY</span>
          </h1>

          <p
            className="font-inter text-lg sm:text-xl md:text-2xl text-light-gray max-w-4xl mx-auto mb-12 leading-relaxed animate-fade-up"
          ...
          <div
            className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-up"
          ...
          <div
            className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto animate-fade-up"
